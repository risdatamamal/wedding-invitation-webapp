<section class="py-5 time text-white"
    style="background-image: url({{ $countdown->imageSrc }}); background-size: cover; background-position: center; background-repeat: no-repeat;">
    <div class="container">
