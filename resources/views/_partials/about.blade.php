    ...
    <div class="row no-gutters align-items-center">
        ...
        <div class="col-md-6 px-3 px-md-0">
            <div class="px-md-5 my-4 my-md-0">
                ...
                <span class="text-muted d-block mt-3 mb-2">Putra {{ $about->man_son_of }} dari Bapak {{ $about->man_father }} dan Ibu {{ $about->man_mother }}</span>
                <p class="lh-lg">
                    {{ $about->man_about }}
                </p>
            </div>
        ...
        <div class="col-md-6 px-3 px-md-0">
            <div class="px-md-5 my-4 my-lg-0 text-md-end">
                ...
                <span class="text-muted d-block my-2">Putri {{ $about->woman_son_of }} dari Bapak {{ $about->woman_father }} dan Ibu {{ $about->woman_mother }}</span>
                <p class="lh-lg">
                    {{ $about->woman_about }}
                </p>
            </div>
