	...
	<div class="col-sm-6 mb-4">
		<div class="card shadow">
			...
			<div class="card-body">
                ...
                <div class="form-group">
					<label>Anak Ke</label>
					<input type="text" class="form-control @error('about.man_son_of') is-invalid @enderror" wire:model="about.man_son_of" placeholder="Anak Ke" autofocus>

					@error('about.man_son_of')
						<span class="invalid-feedback">{{ $message }}</span>
					@enderror
				</div>
				<div class="form-group">
                ...
                <div class="form-group">
					<label>Ibu</label>
					<input type="text" class="form-control @error('about.man_mother') is-invalid @enderror" wire:model="about.man_mother" placeholder="Ibu">

					@error('about.man_mother')
						<span class="invalid-feedback">{{ $message }}</span>
					@enderror
				</div>
				<div class="form-group">
	...
	<div class="col-sm-6 mb-4">
		<div class="card shadow">
			...
			<div class="card-body">
                ...
                <div class="form-group">
					<label>Anak Ke</label>
					<input type="text" class="form-control @error('about.woman_son_of') is-invalid @enderror" wire:model="about.woman_son_of" placeholder="Anak Ke" autofocus>

					@error('about.woman_son_of')
						<span class="invalid-feedback">{{ $message }}</span>
					@enderror
				</div>
				<div class="form-group">
                ...
                <div class="form-group">
					<label>Ibu</label>
					<input type="text" class="form-control @error('about.woman_mother') is-invalid @enderror" wire:model="about.woman_mother" placeholder="Ibu">

					@error('about.woman_mother')
						<span class="invalid-feedback">{{ $message }}</span>
					@enderror
				</div>
				<div class="form-group">
