...
class About extends Model
{
    ...
    protected $fillable = ['man_name', 'man_son_of', 'man_nickname', 'man_father', 'man_mother', 'man_about', 'man_photo', 'woman_name', 'woman_son_of', 'woman_nickname', 'woman_father', 'woman_mother', 'woman_about', 'woman_photo'];
